...
public class Main {
    public static void main(String[] args) {
        ...
        Programa p1 = new Programa(8, 100, 2, 5000);   // Deve rodar com sucesso
        Programa p2 = new Programa(4, 600, 2, 2000);   // Erro de SSD
        Programa p3 = new Programa(32, 100, 2, 3000);  // Erro de RAM
